      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          TextButton(onPressed:() {
            Navigator.push(context, MaterialPageRoute(builder: (context) => WelcomePage(title: '')),
            );
          },
        ...
        children: <Widget>[
          PageView(
            ...
            children: <Widget>[
              ...
              makePage(
                  reverse: true,
                  image: 'assets/images/go-to-work.png',
                  title: Strings.stepTwoTitle,
                  content: Strings.stepTwoContent
              ),
              makePage(
                  image: 'assets/images/traffic-jam.png',
